...
import { isEqual as isEqual$d } from '@appbaseio/reactivecore/lib/utils/helper';
...
var PoweredByImage = styled('img')(_templateObject$1());
...
var container = css(_templateObject$3());
var smallImage = css(_templateObject2$1());
var Image = styled('div')(_templateObject3$1(), function (props) {
  return props.small ? smallImage : null;
}, function (props) {
  return "url(" + props.src + ")";
});
var ListItem = styled('a')(_templateObject4$1(), function (_ref) {
  var theme = _ref.theme;
...
var container$1 = css(_templateObject$4());
var Image$1 = styled('div')(_templateObject2$2(), function (_ref) {
  var colors = _ref.theme.colors;
  return colors.backgroundColor || '#fcfcfc';
});
var Card = styled('a')(_templateObject3$2(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.backgroundColor ? lighten(0.1, theme.colors.backgroundColor) : '#fff';
}, function (_ref3) {
  var theme = _ref3.theme;
...
var leftLabel = css(_templateObject$5());
var rightLabel = css(_templateObject2$3());
var topLabel = css(_templateObject3$3());
var bottomLabel = css(_templateObject4$2());
...
var Flex = styled('div')(_templateObject6$1(), function (props) {
...
var resultStats = css(_templateObject$6());
var sortOptions = css(_templateObject2$4());
...
var isEqual = helper.isEqual,
    ...
    pushToAndClause = helper.pushToAndClause,
...
var ReactiveList = {
  ...
  mounted: function mounted() {
    ...
    var propsKeys = getValidPropsKeys(this.$props);
    this.updateComponentProps(this.componentId, this.$props);
    this.$watch(propsKeys.join('.'), function (newVal, oldVal) {
      checkSomePropChange(newVal, oldVal, propsKeys, function () {
        _this2.updateComponentProps(_this2.componentId, _this2.$props);
      });
    });
  },
  beforeDestroy: function beforeDestroy() {
    ...
    return h("div", {
      ...
      return renderItem({
        ...
        triggerClickAnalytics: function triggerClickAnalytics() {
          return _this3.triggerClickAnalytics(_this3.$currentPage * size + index);
        }
      });
  ...
  methods: {
    ...
    getAggsQuery: function getAggsQuery() {
      ...
      if (aggregationField) {
        queryOptions.aggs = getCompositeAggsQuery({}, this.$props, afterKey ? {
          after: afterKey
        } : null, true).aggs;
      }
    ...
    getData: function getData() {
      var _this$getAllData3 = this.getAllData(),
          results = _this$getAllData3.results,
...
var Base$1 = styled(Base)(_templateObject$7(), function (_ref2) {
  var theme = _ref2.theme;
...
var alertBorder = function alertBorder(_ref) {
  var theme = _ref.theme;
  return css(_templateObject$8(), theme.colors.alertColor);
};

var input = css(_templateObject2$5());

var dark$1 = function dark(theme) {
  return css(_templateObject3$4(), theme.colors.borderColor);
};

var darkInput = function darkInput(_ref2) {
  var theme = _ref2.theme;
  return css(_templateObject4$3(), theme.colors.backgroundColor, theme.colors.textColor, dark$1(theme), theme.colors.backgroundColor);
};

var Input = styled('input')(_templateObject5$2(), input, function (_ref3) {
...
var left = css$1(_templateObject$9());
var right = css$1(_templateObject2$6());
var clear = css$1(_templateObject3$5());
var InputIcon = styled('div')(_templateObject4$4(), function (_ref) {
...
var getClassName$2 = helper.getClassName;
...
var addComponent$1 = Actions.addComponent,
    removeComponent$1 = Actions.removeComponent,
    watchComponent$1 = Actions.watchComponent,
    updateQuery$1 = Actions.updateQuery,
    setQueryOptions$1 = Actions.setQueryOptions,
    setQueryListener$1 = Actions.setQueryListener,
    updateComponentProps$1 = Actions.updateComponentProps;
var debounce = helper.debounce,
    pushToAndClause$1 = helper.pushToAndClause,
    checkValueChange = helper.checkValueChange,
    getClassName$3 = helper.getClassName,
    getOptionsFromQuery$1 = helper.getOptionsFromQuery,
    checkSomePropChange$1 = helper.checkSomePropChange,
    isEqual$2 = helper.isEqual,
...
var DataSearch = {
  ...
  mounted: function mounted() {
    ...
    this.updateComponentProps(this.componentId, this.$props);
    this.$watch(propsKeys.join('.'), function (newVal, oldVal) {
      checkSomePropChange$1(newVal, oldVal, propsKeys, function () {
        _this2.updateComponentProps(_this2.componentId, _this2.$props);
      });
    });
  },
  ...
  methods: {
    ...
    getBasicQueryOptions: function getBasicQueryOptions() {
      ...
      if (aggregationField) {
        queryOptions.aggs = getCompositeAggsQuery$1({}, this.$props, null, true).aggs;
      }
    ...
    onSuggestions: function onSuggestions(results) {
      var parseSuggestion = this.$props.parseSuggestion;
      var fields = Array.isArray(this.$props.dataField) ? this.$props.dataField : [this.$props.dataField];
      var parsedSuggestions = suggestions$1(fields, results, this.$data.currentValue.toLowerCase());
    ...
    triggerClickAnalytics: function triggerClickAnalytics(searchPosition) {
      // click analytics would only work client side and after javascript loads
      var config = this.config,
          suggestionsSearchId = this.analytics.suggestionsSearchId,
    ...
    return h(Container, {
      ...
      "scopedSlots": {
        "default": function _default(_ref) {
          ...
          return h("div", {
            ...
            "class": getClassName$3(_this4.$props.innerClass, 'input'),
            "on": _extends({}, getInputEvents({
              onInput: _this4.onInputChange,
              onBlur: function onBlur(e) {
                _this4.$emit('blur', e, _this4.triggerQuery);
              },
              onFocus: _this4.handleFocus,
              onKeyPress: function onKeyPress(e) {
                _this4.$emit('keyPress', e, _this4.triggerQuery);
              },
              onKeyDown: function onKeyDown(e) {
                return _this4.handleKeyDown(e, highlightedIndex);
              },
              onKeyUp: function onKeyUp(e) {
                _this4.$emit('keyUp', e, _this4.triggerQuery);
              }
            })),
            "domProps": _extends({}, getInputProps({
              value: _this4.$data.currentValue === null ? '' : _this4.$data.currentValue
            }))
          }), _this4.renderIcons(), _this4.hasCustomRenderer && _this4.getComponent({
            isOpen: isOpen,
            getItemProps: getItemProps,
            getItemEvents: getItemEvents,
            highlightedIndex: highlightedIndex
          }), _this4.renderErrorComponent(), !_this4.hasCustomRenderer && isOpen && _this4.suggestionsList.length ? h("ul", {
            "class": suggestions(_this4.themePreset, theme) + " " + getClassName$3(_this4.$props.innerClass, 'list')
            ...
            return h("li", {
              ...
              "attrs": {
                "currentValue": _this4.currentValue,
                "suggestion": item
              }
            })]);
          })]) : _this4.renderNoSuggestions(_this4.suggestionsList), ' ']);
        }
      }
    }) : h("div", {
      "class": suggestionsContainer
      ...
      "on": _extends({}, {
        ...
        focus: function focus(e) {
          _this4.$emit('focus', e, _this4.triggerQuery);
        },
        keydown: function keydown(e) {
          _this4.$emit('keyDown', e, _this4.triggerQuery);
        },
...
var vh = css(_templateObject$b());
var hideInputControl = css(_templateObject2$7());
...
var Radio = styled('input')(_templateObject4$5(), formItem, function (props) {
...
var getCompositeAggsQuery$2 = function getCompositeAggsQuery(query, props, after) {
...
var addComponent$2 = Actions.addComponent,
    removeComponent$2 = Actions.removeComponent,
    watchComponent$2 = Actions.watchComponent,
    updateQuery$2 = Actions.updateQuery,
    setQueryOptions$2 = Actions.setQueryOptions,
    setQueryListener$2 = Actions.setQueryListener,
    updateComponentProps$2 = Actions.updateComponentProps;
var getQueryOptions$1 = helper.getQueryOptions,
    pushToAndClause$2 = helper.pushToAndClause,
    checkValueChange$1 = helper.checkValueChange,
    getClassName$4 = helper.getClassName,
    getOptionsFromQuery$2 = helper.getOptionsFromQuery,
    isEqual$3 = helper.isEqual,
    checkSomePropChange$2 = helper.checkSomePropChange;
var SingleList = {
  name: 'SingleList',
  props: {
    beforeValueChange: types.func,
  ...
  mounted: function mounted() {
    ...
    this.updateComponentProps(this.componentId, this.$props);
    this.$watch(propsKeys.join('.'), function (newVal, oldVal) {
      checkSomePropChange$2(newVal, oldVal, propsKeys, function () {
        _this2.updateComponentProps(_this2.componentId, _this2.$props);
      });
    });
  },
  ...
  render: function render() {
    ...
    return h(Container, {
      ...
      return h("li", {
        "key": item.key,
        "class": "" + (_this3.currentValue === String(item.key) ? 'active' : '')
      }, [h(Radio, {
        "class": getClassName$4(_this3.$props.innerClass, 'radio'),
        "attrs": {
        ...
        "domProps": _extends({}, {
          checked: _this3.currentValue === String(item.key)
        })
      }), h("label", {
        "class": getClassName$4(_this3.$props.innerClass, 'label') || null,
        "attrs": {
        ...
        isChecked: _this3.currentValue === String(item.key)
      }) : h("span", [item.key, _this3.$props.showCount && h("span", {
        "class": getClassName$4(_this3.$props.innerClass, 'count') || null
      }, ["\xA0(", item.doc_count, ")"])])])]);
    })])]);
  },
  methods: {
    ...
    setValue: function setValue(nextValue, props) {
      ...
      var performUpdate = function performUpdate() {
        ...
        _this4.updateQueryHandler(value, props);
...
var addComponent$3 = Actions.addComponent,
    removeComponent$3 = Actions.removeComponent,
    watchComponent$3 = Actions.watchComponent,
    updateQuery$3 = Actions.updateQuery,
    setQueryOptions$3 = Actions.setQueryOptions,
    setQueryListener$3 = Actions.setQueryListener,
    updateComponentProps$3 = Actions.updateComponentProps;
var isEqual$4 = helper.isEqual,
    getQueryOptions$2 = helper.getQueryOptions,
    pushToAndClause$3 = helper.pushToAndClause,
    checkValueChange$2 = helper.checkValueChange,
    getClassName$5 = helper.getClassName,
    getOptionsFromQuery$3 = helper.getOptionsFromQuery,
    checkSomePropChange$3 = helper.checkSomePropChange;
var MultiList = {
  name: 'MultiList',
  props: {
  ...
  mounted: function mounted() {
    ...
    this.updateComponentProps(this.componentId, this.$props);
    this.$watch(propsKeys.join('.'), function (newVal, oldVal) {
      checkSomePropChange$3(newVal, oldVal, propsKeys, function () {
        _this2.updateComponentProps(_this2.componentId, _this2.$props);
      });
    });
  },
    ...
    selectedValue: function selectedValue(newVal) {
      ...
      if (this.$props.selectAllLabel) {
        selectedValue = selectedValue.filter(function (val) {
          return val !== _this3.$props.selectAllLabel;
        });
      ...
      if (!isEqual$4(selectedValue, newVal)) {
        this.setValue(newVal || [], true);
      }
    }
  },
  render: function render() {
    ...
    return h(Container, {
      ...
      }) : h("span", [item.key, _this4.$props.showCount && h("span", {
  ...
  methods: {
    ...
    setValue: function setValue(value, isDefaultValue, props) {
      ...
      var performUpdate = function performUpdate() {
        _this5.currentValue = Object.assign({}, currentValue);

        _this5.updateQueryHandler(finalValues, props);

        _this5.locked = false;

        _this5.$emit('valueChange', finalValues);
      };
...
var small = css(_templateObject$c());

var dark$2 = function dark(_ref) {
  var theme = _ref.theme;
  return css(_templateObject2$8(), theme.colors.backgroundColor, theme.colors.borderColor, theme.colors.textColor, theme.colors.backgroundColor);
};

var Select = styled('button')(_templateObject3$7(), function (props) {
  return props.small ? small : null;
}, function (_ref2) {
  var themePreset = _ref2.themePreset;
  return themePreset === 'dark' && dark$2;
});
var Tick = styled('span')(_templateObject4$6(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.colors.primaryColor;
});
...
var open = css(_templateObject$d());
var Chevron = styled('span')(_templateObject2$9(), function (props) {
  return props.open ? open : null;
});

var getClassName$6 = helper.getClassName;
var Dropdown = {
  data: function data() {
    this.__state = {
      isOpen: false,
...
var addComponent$4 = Actions.addComponent,
    removeComponent$4 = Actions.removeComponent,
    watchComponent$4 = Actions.watchComponent,
    updateQuery$4 = Actions.updateQuery,
    setQueryOptions$4 = Actions.setQueryOptions,
    setQueryListener$4 = Actions.setQueryListener,
    updateComponentProps$4 = Actions.updateComponentProps;
var getQueryOptions$3 = helper.getQueryOptions,
    pushToAndClause$4 = helper.pushToAndClause,
    checkValueChange$3 = helper.checkValueChange,
    checkPropChange = helper.checkPropChange,
    getClassName$7 = helper.getClassName,
    getOptionsFromQuery$4 = helper.getOptionsFromQuery,
    isEqual$5 = helper.isEqual,
    checkSomePropChange$4 = helper.checkSomePropChange;
var SingleDropdownList = {
  ...
  mounted: function mounted() {
    ...
    this.updateComponentProps(this.componentId, this.$props);
    this.$watch(propsKeys.join('.'), function (newVal, oldVal) {
      checkSomePropChange$4(newVal, oldVal, propsKeys, function () {
        _this2.updateComponentProps(_this2.componentId, _this2.$props);
      });
    });
  },
  ...
  methods: {
    ...
    generateQueryOptions: function generateQueryOptions(props, after) {
      ...
      return props.showLoadMore ? getCompositeAggsQuery$2(queryOptions, props, after) : getAggsQuery(queryOptions, props);
    },
...
var mapDispatchtoProps$5 = {
  ...
  updateComponentProps: updateComponentProps$4
};
...
var addComponent$5 = Actions.addComponent,
    removeComponent$5 = Actions.removeComponent,
    watchComponent$5 = Actions.watchComponent,
    updateQuery$5 = Actions.updateQuery,
    setQueryOptions$5 = Actions.setQueryOptions,
    setQueryListener$5 = Actions.setQueryListener,
    updateComponentProps$5 = Actions.updateComponentProps;
var isEqual$6 = helper.isEqual,
    getQueryOptions$4 = helper.getQueryOptions,
    pushToAndClause$5 = helper.pushToAndClause,
    checkValueChange$4 = helper.checkValueChange,
    checkPropChange$1 = helper.checkPropChange,
    getClassName$8 = helper.getClassName,
    getOptionsFromQuery$5 = helper.getOptionsFromQuery,
    checkSomePropChange$5 = helper.checkSomePropChange;
var MultiDropdownList = {
  ...
  mounted: function mounted() {
    ...
    this.updateComponentProps(this.componentId, this.$props);
    this.$watch(propsKeys.join('.'), function (newVal, oldVal) {
      checkSomePropChange$5(newVal, oldVal, propsKeys, function () {
        _this2.updateComponentProps(_this2.componentId, _this2.$props);
      });
    });
  },
    ...
    options: function options(newVal, oldVal) {
      ...
      checkPropChange$1(oldVal, newVal, function () {
        var _this4$$props = _this4.$props,
            showLoadMore = _this4$$props.showLoadMore,
            dataField = _this4$$props.dataField;
        var modifiedOptions = _this4.$data.modifiedOptions;
        ...
        if (showLoadMore) {
          ...
          _this4.isLastBucket = isLastBucket;
          _this4.modifiedOptions = nextOptions;
        } else {
          _this4.modifiedOptions = newVal[_this4.$props.dataField] ? newVal[_this4.$props.dataField].buckets : [];
        }
      });
    },
    size: function size() {
...
var mapDispatchtoProps$6 = {
  ...
  updateComponentProps: updateComponentProps$5
};
...
var addComponent$6 = Actions.addComponent,
    removeComponent$6 = Actions.removeComponent,
    updateQuery$6 = Actions.updateQuery,
    watchComponent$6 = Actions.watchComponent,
    setQueryListener$6 = Actions.setQueryListener,
    setQueryOptions$6 = Actions.setQueryOptions;
var isEqual$7 = helper.isEqual,
    checkValueChange$5 = helper.checkValueChange,
    getClassName$9 = helper.getClassName,
    getOptionsFromQuery$6 = helper.getOptionsFromQuery,
    handleA11yAction$1 = helper.handleA11yAction;
var ToggleButton = {
  name: 'ToggleButton',
  props: {
    componentId: types.stringRequired,
  ...
  watch: {
    ...
    selectedValue: function selectedValue(newVal, oldVal) {
      if (this.$props.multiSelect) {
        ...
        if (!isEqual$7(this.$data.currentValue, newVal) && !isEqual$7(oldVal, newVal)) {
          this.handleToggle(newVal || [], true, this.$props);
        }
      } else {
        ...
        if (!isEqual$7(currentValue, this.selectedValue) && !isEqual$7(oldVal, this.selectedValue)) {
...
var addComponent$7 = Actions.addComponent,
    removeComponent$7 = Actions.removeComponent,
    watchComponent$7 = Actions.watchComponent,
    updateQuery$7 = Actions.updateQuery,
    setQueryOptions$7 = Actions.setQueryOptions,
    setQueryListener$7 = Actions.setQueryListener;
var pushToAndClause$6 = helper.pushToAndClause,
    parseHits$1 = helper.parseHits,
    isEqual$8 = helper.isEqual,
    getCompositeAggsQuery$3 = helper.getCompositeAggsQuery,
    getOptionsFromQuery$7 = helper.getOptionsFromQuery;
var ReactiveComponent = {
  ...
  watch: {
    ...
    defaultQuery: function defaultQuery(newVal, oldVal) {
      if (newVal && !isEqual$8(newVal(), oldVal)) {
        this.$defaultQuery = newVal();
  ...
  methods: {
    ...
    getAggsQuery: function getAggsQuery() {
      if (this.aggregationField) {
        return {
          aggs: getCompositeAggsQuery$3({}, this.$props, null, true).aggs
        };
      }
...
var patchValue = Actions.patchValue,
    clearValues = Actions.clearValues;
var getClassName$a = helper.getClassName,
    handleA11yAction$2 = helper.handleA11yAction;
var SelectedFilters = {
...
var addComponent$8 = Actions.addComponent,
    removeComponent$8 = Actions.removeComponent,
    watchComponent$8 = Actions.watchComponent,
    updateQuery$8 = Actions.updateQuery,
    setQueryListener$8 = Actions.setQueryListener,
    setQueryOptions$8 = Actions.setQueryOptions;
var isEqual$9 = helper.isEqual,
    checkValueChange$6 = helper.checkValueChange,
    getClassName$b = helper.getClassName,
    getOptionsFromQuery$8 = helper.getOptionsFromQuery;
var SingleRange = {
  name: 'SingleRange',
  data: function data() {
    this.__state = {
  ...
  watch: {
    ...
    selectedValue: function selectedValue(newVal) {
      if (!isEqual$9(this.$data.currentValue, newVal)) {
        this.setValue(newVal);
      }
    }
  },
...
var addComponent$9 = Actions.addComponent,
    removeComponent$9 = Actions.removeComponent,
    watchComponent$9 = Actions.watchComponent,
    updateQuery$9 = Actions.updateQuery,
    setQueryListener$9 = Actions.setQueryListener,
    setQueryOptions$9 = Actions.setQueryOptions;
var isEqual$a = helper.isEqual,
    checkValueChange$7 = helper.checkValueChange,
    getClassName$c = helper.getClassName,
    getOptionsFromQuery$9 = helper.getOptionsFromQuery;
var MultiRange = {
  name: 'MultiRange',
  data: function data() {
    this.state = {
  ...
  watch: {
    ...
    selectedValue: function selectedValue(newVal) {
      if (!isEqual$a(this.$data.currentValue, newVal)) {
...
var ResultCardImage = {
  ...
  render: function render() {
    ...
    return h(Image$1, _mergeJSXProps([{
      "style": {
...
var Slider = styled('div')(_templateObject$e());
...
var addComponent$a = Actions.addComponent,
    removeComponent$a = Actions.removeComponent,
    watchComponent$a = Actions.watchComponent,
    updateQuery$a = Actions.updateQuery,
    setQueryListener$a = Actions.setQueryListener,
    setQueryOptions$a = Actions.setQueryOptions;
var checkValueChange$8 = helper.checkValueChange,
    getClassName$d = helper.getClassName,
    getOptionsFromQuery$a = helper.getOptionsFromQuery,
    isEqual$b = helper.isEqual;
var RangeSlider = {
  name: 'RangeSlider',
...
var addComponent$b = Actions.addComponent,
    removeComponent$b = Actions.removeComponent,
    watchComponent$b = Actions.watchComponent,
    updateQuery$b = Actions.updateQuery,
    setQueryListener$b = Actions.setQueryListener,
    setQueryOptions$b = Actions.setQueryOptions;
var checkValueChange$9 = helper.checkValueChange,
    getClassName$e = helper.getClassName,
    getOptionsFromQuery$b = helper.getOptionsFromQuery,
    isEqual$c = helper.isEqual;
...
var StateProviderConnected = connect(mapStateToProps$e, {})(StateProvider);

StateProvider.install = function (Vue) {
  Vue.component(StateProvider.name, StateProviderConnected);
};

var buildQuery = helper.buildQuery,
    pushToAndClause$7 = helper.pushToAndClause;
var valueReducer = Reducers.valueReducer,
    queryReducer = Reducers.queryReducer,
    queryOptionsReducer = Reducers.queryOptionsReducer,
    dependencyTreeReducer = Reducers.dependencyTreeReducer;
...
function initReactivesearch(componentCollection, searchState, settings) {
  return new Promise(function (resolve, reject) {
    ...
    componentCollection.forEach(function (component) {
      ...
      var value = getValue(searchState, label, component.defaultValue); // [1] set selected values
...
var components = [ReactiveList, ResultCard, ResultList, ReactiveBase, DataSearch, SingleList, MultiList, SingleRange, MultiRange, RangeSlider, DynamicRangeSlider, ReactiveComponent, SelectedFilters, ToggleButton, SingleDropdownList, MultiDropdownList, StateProvider];
...
export { DataSearch, DynamicRangeSlider, MultiDropdownList, MultiList, MultiRange, RangeSlider, ReactiveBase, ReactiveComponent, ReactiveList, ResultCard, ResultList, SelectedFilters, SingleDropdownList, SingleList, SingleRange, StateProvider, ToggleButton, initReactivesearch, install, version };
